...
while True:
    ...
    if left_position > right_position:
        difference = left_position - right_position
        adjustment = difference / 2
        motor1.duty_cycle = motor1_duty_cycle - adjustment
        motor2.duty_cycle = motor2_duty_cycle + adjustment
    if left_position < right_position:
        difference = right_position - left_position
        adjustment = difference / 2
        motor1.duty_cycle = motor1_duty_cycle + adjustment
        motor2.duty_cycle = motor2_duty_cycle - adjustment
