...
def run_control_loop(theta_target, dist_target):
    ...
    left_motor.duty_cycle, right_motor.duty_cycle = int(abs((limit(start_line - start_angle, -1, 1))) * 65535), int(abs((limit(start_line + start_angle, -1, 1))) * 65535)
